...
public class TbSfpyClientDao extends TbSfpyClient implements IBaseTbDao {

	private static TbSfpyClientDao instance = new TbSfpyClientDao();

	public static TbSfpyClientDao getInstance() {
		if (instance == null) {
			instance = new TbSfpyClientDao();
		}
		return instance;
	}
	...
	public Map<String, Object> getDataById(Field[] fields, Object id) throws Exception {
		String condition = CLIENT_ID.toSqlEQ(id);
