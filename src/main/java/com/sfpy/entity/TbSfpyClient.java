...
public class TbSfpyClient extends AbstractTable {
	...
	public static Field CLIENT_NAME = new Field("用户名", "CLIENT_NAME", new StringType());
	public static Field CLIENT_PSWD = new Field("密码", "CLIENT_PSWD", new StringType());
	public static Field CLIENT_REALLY_NAME = new Field("姓名", "CLIENT_REALLY_NAME", new StringType());
